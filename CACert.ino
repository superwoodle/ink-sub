// Generated by using https://github.com/SensorsIot/HTTPS-for-Makers/blob/master/CertToESP8266.py
// Using the root certificate for www.googleapis.com, exported from Google Chrome on windows 
...
const unsigned int caCertLen = 958;
